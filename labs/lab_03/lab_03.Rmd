...
A1:Charleston had 2836	loans. South Charleston	had 484	loans. Saint Albans	had 304	loans. Dunbar	has 166	loans. Nitro had 142 loans. 
```{r}
...
A2: The zipcode that got the most money is 25301. It is located in Charleston. The business name is Jackson Kelly PLLC. The total was 5068472.00. The forgiveness amount of the loan 5126618.64. The forgviveness amount is bigger than the original amount because of interest rates on the loan. 
...
A3:
DM Motor INC, Dutch Miller of Charleston Inc, Dutch Miller of Charlotte Inc, Dutch Miller Subaru Inc, Dutch Miller Chevrolet Inc are the 5 entities owned by the Millers. The 5 of them are all car dealerships. Originally Carol Miller did not support the legislation for the laon program. The total amount all the businesses received is 3105300. The amount that has been forgiven is 3140471, and the percentage is 1.011326.	
```{r}
