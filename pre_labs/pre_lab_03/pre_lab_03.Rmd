...
**Answer**
One problem is there is a fully duplicated row (the first and second). Another problem is that the street address field is inconsistent. One last problem is that the column headers are inconsistently styled. 
```{r}
arnold_md_loans
```
