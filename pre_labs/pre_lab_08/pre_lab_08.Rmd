...
**Answer**
The largest percent change was Nevada with 35.14 percent. 
...
**Answer**
The county with the highest median household income is Howard County Maryland. 
```{r}
...
**Answer**
The bars overlap, which means the differences aren't statistically significant. 
Is the difference between Howard and everyone else significant?
**Answer**
Yes it is significant. This is becuase this bar does not overlap with any other bar. 
...
**Answer**
Somerset and Caroline county both saw their median incomes fall. Yes it is outside the margin of error for both. 
```{r}
md10 %>%
...
**Answer**
20850, 20852, 21202, 21740, and 21201 all have estimates less than 50,000. (5 out of the top 20 have median household incomes less than 50,000 dollars.)
```{r}
