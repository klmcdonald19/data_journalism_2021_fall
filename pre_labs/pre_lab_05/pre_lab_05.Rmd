...
**Answer**
There is capitalization differences between some of the entries. For example, there is Abell and ABELL, which causes them to not be grouped together. 
```{r}
...
**Answer**
PHOENIX changed to Phoenix. WESTMINSTER changed to Westminster. 
```{r}
...
**Answer**
ABELL became Abell. aberdeen became Aberdeen. abingdon became Abingdon. 
```{r}
cleaned_md_loans %>%
...
**Answer**
No, these don't differ substantially. They are the same. This makes me think both functions do the same cleaning to the data. 
