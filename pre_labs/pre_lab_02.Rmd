...
**Answer**
The payroll percentage for the first result is 100 percent. 
...
What is the payroll proceeds percentage for the first result? Put your answer in the space below.
**Answer**
The payroll percentage for the first result is 0 percent. 
...
**Answer**
The number of applications that fit the criteria is 145. 
...
What is the number of applications that meet that criteria? Put your answer in the space below.
**Answer**
The number of applications that meet that criteria is 145. 
...
What is the number of applications that meet that criteria? Put your answer in the space below.
**Answer**
The number of applications that meet that criteria is 54321. 
...
**Answer**
April saw the most applications. It was a total of 45043. 
